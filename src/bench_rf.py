...
def run_rf_cv(
    ...
    class_weight: str = "balanced_subsample",  # "balanced", "balanced_subsample", "none"
    n_jobs: int = 4,
) -> Dict[str, Any]:
    ...
    print(f"[INFO] RF params: n_estimators={n_estimators} max_depth={max_depth} "
          f"min_samples_leaf={min_samples_leaf} max_features={max_features} class_weight={class_weight}")
    ...
    if append_log and results_jsonl is not None:
        ...
        try:
            ...
            # fallback: write compatible schema directly
            record = {
    ...
    print("\n===== CV Final Results (RF mean pooling) =====")
...
def main():
    ...
    ap.add_argument("--out_dir", default="results_rf")
    ...
    ap.add_argument("--max_features", default="sqrt", choices=["sqrt", "log2", "auto"])
